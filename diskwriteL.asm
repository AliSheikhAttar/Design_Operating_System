...
int main(int argc, char *argv[]) {
  ...
  19:	89 45 c4             	mov    %eax,-0x3c(%ebp)
        int start_time, end_time;
         start_time = uptime();
  1c:	e8 0a 06 00 00       	call   62b <uptime>
  21:	89 45 c0             	mov    %eax,-0x40(%ebp)
    if (argc < 2) {
  24:	83 fb 01             	cmp    $0x1,%ebx
  27:	7e 57                	jle    80 <main+0x80>
  ...
  2c:	bf 01 00 00 00       	mov    $0x1,%edi
    char *text = argv[1];
  31:	8b 70 04             	mov    0x4(%eax),%esi

    if (argc == 3) {
  34:	83 fb 03             	cmp    $0x3,%ebx
  37:	74 5a                	je     93 <main+0x93>
  39:	8d 5d d4             	lea    -0x2c(%ebp),%ebx
  ...
  44:	57                   	push   %edi
    for (int i = start_index; i <= 100; i++) {
  45:	83 c7 01             	add    $0x1,%edi
        create_filename("file", i, filename);
  48:	68 74 0a 00 00       	push   $0xa74
  4d:	e8 ee 00 00 00       	call   140 <create_filename>
  ...
  54:	56                   	push   %esi
  55:	53                   	push   %ebx
  56:	e8 25 02 00 00       	call   280 <write_to_file>
    for (int i = start_index; i <= 100; i++) {
  5b:	83 c4 10             	add    $0x10,%esp
  5e:	83 ff 65             	cmp    $0x65,%edi
  61:	75 dd                	jne    40 <main+0x40>
    }
    end_time = uptime();
  63:	e8 c3 05 00 00       	call   62b <uptime>
    printf(1, "Time taken: %d ticks\n", end_time - start_time);
  68:	83 ec 04             	sub    $0x4,%esp
  6b:	2b 45 c0             	sub    -0x40(%ebp),%eax
  6e:	50                   	push   %eax
  6f:	68 79 0a 00 00       	push   $0xa79
  74:	6a 01                	push   $0x1
  76:	e8 85 06 00 00       	call   700 <printf>
    exit();
  7b:	e8 13 05 00 00       	call   593 <exit>
        printf(2, "Usage: create_files <text> [start_index]\n");
  80:	51                   	push   %ecx
  81:	51                   	push   %ecx
  82:	68 90 0a 00 00       	push   $0xa90
  87:	6a 02                	push   $0x2
  89:	e8 72 06 00 00       	call   700 <printf>
        exit();
  8e:	e8 00 05 00 00       	call   593 <exit>
        start_index = atoi(argv[2]);
  93:	83 ec 0c             	sub    $0xc,%esp
  96:	ff 70 08             	push   0x8(%eax)
  99:	e8 82 04 00 00       	call   520 <atoi>
    for (int i = start_index; i <= 100; i++) {
  9e:	83 c4 10             	add    $0x10,%esp
        start_index = atoi(argv[2]);
  a1:	89 c7                	mov    %eax,%edi
    for (int i = start_index; i <= 100; i++) {
  a3:	83 f8 64             	cmp    $0x64,%eax
  a6:	7e 91                	jle    39 <main+0x39>
  a8:	eb b9                	jmp    63 <main+0x63>
  aa:	66 90                	xchg   %ax,%ax
  ac:	66 90                	xchg   %ax,%ax
  ae:	66 90                	xchg   %ax,%ax
...
void int_to_str(int n, char *str) {
  ...
  b8:	53                   	push   %ebx
    if (n == 0) {
  b9:	85 c9                	test   %ecx,%ecx
  bb:	74 63                	je     120 <int_to_str+0x70>
    while (temp_n > 0) {
  bd:	89 ca                	mov    %ecx,%edx
    int len = 0;
  bf:	be 00 00 00 00       	mov    $0x0,%esi
    while (temp_n > 0) {
  c4:	7e 6a                	jle    130 <int_to_str+0x80>
  c6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  cd:	8d 76 00             	lea    0x0(%esi),%esi
        temp_n /= 10;
  d0:	b8 cd cc cc cc       	mov    $0xcccccccd,%eax
  d5:	89 d7                	mov    %edx,%edi
  d7:	89 f3                	mov    %esi,%ebx
        len++;
  d9:	83 c6 01             	add    $0x1,%esi
        temp_n /= 10;
  dc:	f7 e2                	mul    %edx
  de:	c1 ea 03             	shr    $0x3,%edx
    while (temp_n > 0) {
  e1:	83 ff 09             	cmp    $0x9,%edi
  e4:	7f ea                	jg     d0 <int_to_str+0x20>
    str[len] = '\0';
  e6:	8b 45 0c             	mov    0xc(%ebp),%eax
  e9:	c6 04 30 00          	movb   $0x0,(%eax,%esi,1)
    while (n > 0) {
  ed:	01 c3                	add    %eax,%ebx
        str[--len] = (n % 10) + '0';
  ef:	be cd cc cc cc       	mov    $0xcccccccd,%esi
 ...
 101:	c1 ea 03             	shr    $0x3,%edx
 104:	8d 3c 92             	lea    (%edx,%edx,4),%edi
 107:	01 ff                	add    %edi,%edi
 109:	29 f8                	sub    %edi,%eax
 10b:	83 c0 30             	add    $0x30,%eax
 10e:	88 43 01             	mov    %al,0x1(%ebx)
        n /= 10;
 111:	89 c8                	mov    %ecx,%eax
 113:	89 d1                	mov    %edx,%ecx
    while (n > 0) {
 115:	83 f8 09             	cmp    $0x9,%eax
 118:	7f de                	jg     f8 <int_to_str+0x48>
}
 11a:	5b                   	pop    %ebx
 11b:	5e                   	pop    %esi
 11c:	5f                   	pop    %edi
 ...
 123:	ba 30 00 00 00       	mov    $0x30,%edx
 128:	66 89 10             	mov    %dx,(%eax)
}
 12b:	5b                   	pop    %ebx
 12c:	5e                   	pop    %esi
 12d:	5f                   	pop    %edi
 ...
 133:	c6 00 00             	movb   $0x0,(%eax)
    while (n > 0) {
 136:	eb e2                	jmp    11a <int_to_str+0x6a>
 138:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 13f:	90                   	nop

00000140 <create_filename>:
void create_filename(char *base, int num, char *filename) {
 ...
 14c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    while (base[i] != '\0') {
 14f:	0f b6 06             	movzbl (%esi),%eax
 152:	84 c0                	test   %al,%al
 154:	0f 84 06 01 00 00    	je     260 <create_filename+0x120>
    int i = 0;
 15a:	8b 7d 10             	mov    0x10(%ebp),%edi
 15d:	31 c9                	xor    %ecx,%ecx
 15f:	90                   	nop
        filename[i] = base[i];
 160:	88 04 0f             	mov    %al,(%edi,%ecx,1)
        i++;
 163:	89 ca                	mov    %ecx,%edx
 165:	83 c1 01             	add    $0x1,%ecx
    while (base[i] != '\0') {
 168:	0f b6 04 0e          	movzbl (%esi,%ecx,1),%eax
 16c:	84 c0                	test   %al,%al
 16e:	75 f0                	jne    160 <create_filename+0x20>
    filename[i++] = '.';
 170:	8b 45 10             	mov    0x10(%ebp),%eax
 173:	01 c8                	add    %ecx,%eax
 175:	89 45 e0             	mov    %eax,-0x20(%ebp)
 178:	8d 42 02             	lea    0x2(%edx),%eax
 17b:	89 45 dc             	mov    %eax,-0x24(%ebp)
    if (n == 0) {
 17e:	85 db                	test   %ebx,%ebx
 180:	0f 84 ca 00 00 00    	je     250 <create_filename+0x110>
    while (temp_n > 0) {
 186:	89 da                	mov    %ebx,%edx
    int len = 0;
 188:	be 00 00 00 00       	mov    $0x0,%esi
    while (temp_n > 0) {
 18d:	0f 8e 95 00 00 00    	jle    228 <create_filename+0xe8>
 193:	89 4d d8             	mov    %ecx,-0x28(%ebp)
 ...
 1ae:	c1 ea 03             	shr    $0x3,%edx
    while (temp_n > 0) {
 1b1:	83 f9 09             	cmp    $0x9,%ecx
 1b4:	7f ea                	jg     1a0 <create_filename+0x60>
    str[len] = '\0';
 1b6:	c6 44 35 ea 00       	movb   $0x0,-0x16(%ebp,%esi,1)
 1bb:	8b 4d d8             	mov    -0x28(%ebp),%ecx
    while (n > 0) {
 1be:	8d 75 ea             	lea    -0x16(%ebp),%esi
 1c1:	01 fe                	add    %edi,%esi
 1c3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 1c7:	90                   	nop
        str[--len] = (n % 10) + '0';
 1c8:	b8 cd cc cc cc       	mov    $0xcccccccd,%eax
    while (n > 0) {
 1cd:	83 ee 01             	sub    $0x1,%esi
        str[--len] = (n % 10) + '0';
 1d0:	f7 e3                	mul    %ebx
 1d2:	89 d8                	mov    %ebx,%eax
 1d4:	c1 ea 03             	shr    $0x3,%edx
 1d7:	8d 3c 92             	lea    (%edx,%edx,4),%edi
 1da:	01 ff                	add    %edi,%edi
 1dc:	29 f8                	sub    %edi,%eax
 1de:	83 c0 30             	add    $0x30,%eax
 1e1:	88 46 01             	mov    %al,0x1(%esi)
        n /= 10;
 1e4:	89 d8                	mov    %ebx,%eax
 1e6:	89 d3                	mov    %edx,%ebx
    while (n > 0) {
 1e8:	83 f8 09             	cmp    $0x9,%eax
 1eb:	7f db                	jg     1c8 <create_filename+0x88>
    while (num_str[j] != '\0') {
 1ed:	0f b6 55 ea          	movzbl -0x16(%ebp),%edx
 1f1:	8d 5d ea             	lea    -0x16(%ebp),%ebx
 1f4:	0f b6 45 eb          	movzbl -0x15(%ebp),%eax
 1f8:	8b 75 10             	mov    0x10(%ebp),%esi
 1fb:	29 cb                	sub    %ecx,%ebx
 1fd:	84 d2                	test   %dl,%dl
 1ff:	75 0e                	jne    20f <create_filename+0xcf>
 201:	eb 25                	jmp    228 <create_filename+0xe8>
 203:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 207:	90                   	nop
 208:	89 c2                	mov    %eax,%edx
 20a:	0f b6 44 19 01       	movzbl 0x1(%ecx,%ebx,1),%eax
        filename[i++] = num_str[j++];
 20f:	83 c1 01             	add    $0x1,%ecx
 212:	88 54 0e ff          	mov    %dl,-0x1(%esi,%ecx,1)
    while (num_str[j] != '\0') {
 216:	84 c0                	test   %al,%al
 218:	75 ee                	jne    208 <create_filename+0xc8>
    filename[i++] = '.';
 21a:	8b 45 10             	mov    0x10(%ebp),%eax
 21d:	01 c8                	add    %ecx,%eax
 21f:	89 45 e0             	mov    %eax,-0x20(%ebp)
 222:	8d 41 01             	lea    0x1(%ecx),%eax
 225:	89 45 dc             	mov    %eax,-0x24(%ebp)
 228:	8b 45 e0             	mov    -0x20(%ebp),%eax
    filename[i++] = 't';
 22b:	8b 7d dc             	mov    -0x24(%ebp),%edi
    filename[i++] = '.';
 22e:	c6 00 2e             	movb   $0x2e,(%eax)
    filename[i++] = 't';
 231:	8b 45 10             	mov    0x10(%ebp),%eax
 234:	c6 04 38 74          	movb   $0x74,(%eax,%edi,1)
    filename[i++] = 'x';
 238:	c6 44 08 02 78       	movb   $0x78,0x2(%eax,%ecx,1)
    filename[i++] = 't';
 23d:	c6 44 08 03 74       	movb   $0x74,0x3(%eax,%ecx,1)
    filename[i] = '\0'; // Null-terminate the string
 242:	c6 44 08 04 00       	movb   $0x0,0x4(%eax,%ecx,1)
}
 ...
 256:	c6 44 08 ff 30       	movb   $0x30,-0x1(%eax,%ecx,1)
    while (num_str[j] != '\0') {
 25b:	eb bd                	jmp    21a <create_filename+0xda>
 25d:	8d 76 00             	lea    0x0(%esi),%esi
    while (base[i] != '\0') {
 260:	8b 45 10             	mov    0x10(%ebp),%eax
 263:	c7 45 dc 01 00 00 00 	movl   $0x1,-0x24(%ebp)
    int i = 0;
 26a:	31 c9                	xor    %ecx,%ecx
    while (base[i] != '\0') {
 26c:	89 45 e0             	mov    %eax,-0x20(%ebp)
 26f:	e9 0a ff ff ff       	jmp    17e <create_filename+0x3e>
 274:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 27b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 27f:	90                   	nop

00000280 <write_to_file>:
void write_to_file(char *filename, char *text) {
 ...
 28c:	8b 7d 08             	mov    0x8(%ebp),%edi
    int n = strlen(text);
 28f:	52                   	push   %edx
 290:	89 55 e4             	mov    %edx,-0x1c(%ebp)
 293:	e8 38 01 00 00       	call   3d0 <strlen>
 298:	89 c6                	mov    %eax,%esi
    fd = open(filename, O_WRONLY | O_CREATE);
 29a:	58                   	pop    %eax
 29b:	5a                   	pop    %edx
 29c:	68 01 02 00 00       	push   $0x201
 2a1:	57                   	push   %edi
 2a2:	e8 2c 03 00 00       	call   5d3 <open>
    if (fd < 0) {
 2a7:	83 c4 10             	add    $0x10,%esp
 2aa:	8b 55 e4             	mov    -0x1c(%ebp),%edx
 2ad:	85 c0                	test   %eax,%eax
 2af:	78 67                	js     318 <write_to_file+0x98>
 ...
 2b7:	52                   	push   %edx
 2b8:	50                   	push   %eax
 2b9:	e8 f5 02 00 00       	call   5b3 <write>
 2be:	83 c4 10             	add    $0x10,%esp
 2c1:	39 f0                	cmp    %esi,%eax
 2c3:	75 2b                	jne    2f0 <write_to_file+0x70>
    close(fd);
 2c5:	83 ec 0c             	sub    $0xc,%esp
 2c8:	53                   	push   %ebx
 2c9:	e8 ed 02 00 00       	call   5bb <close>
    printf(1, "Successfully wrote to %s\n", filename); // Debugging print
 2ce:	83 c4 0c             	add    $0xc,%esp
 2d1:	57                   	push   %edi
 2d2:	68 5a 0a 00 00       	push   $0xa5a
 2d7:	6a 01                	push   $0x1
 2d9:	e8 22 04 00 00       	call   700 <printf>
 2de:	83 c4 10             	add    $0x10,%esp
}
 2e1:	8d 65 f4             	lea    -0xc(%ebp),%esp
 2e4:	5b                   	pop    %ebx
 2e5:	5e                   	pop    %esi
 2e6:	5f                   	pop    %edi
 2e7:	5d                   	pop    %ebp
 ...
 2f3:	57                   	push   %edi
 2f4:	68 3f 0a 00 00       	push   $0xa3f
 2f9:	6a 02                	push   $0x2
 2fb:	e8 00 04 00 00       	call   700 <printf>
        close(fd);
 300:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
sys_ps:
    movl SYS_ps, %eax
 63b:	a1 16 00 00 00       	mov    0x16,%eax
    int $64
 640:	cd 40                	int    $0x40
    ret
 642:	c3                   	ret    
 ...
 65c:	89 d1                	mov    %edx,%ecx
{
 ...
 689:	0f b6 92 1c 0b 00 00 	movzbl 0xb1c(%edx),%edx
 ...
 709:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 779:	ff 24 85 c4 0a 00 00 	jmp    *0xac4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 887:	90                   	nop
          s = "(null)";
 888:	ba ba 0a 00 00       	mov    $0xaba,%edx
        while(*s != 0){
