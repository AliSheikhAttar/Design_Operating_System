...
int main(int argc, char *argv[]) {
  ...
  1b:	53                   	push   %ebx
  1c:	51                   	push   %ecx
  1d:	81 ec 10 0c 00 00    	sub    $0xc10,%esp
    int A[N][N], B[N][N], C[N][N];
    int i, j;
    printf(1, "1\n");
  23:	68 8c 08 00 00       	push   $0x88c
  28:	6a 01                	push   $0x1
  ...
  63:	8d 9d e8 fb ff ff    	lea    -0x418(%ebp),%ebx
    printf(1, "2\n");
  69:	68 8f 08 00 00       	push   $0x88f
  6e:	6a 01                	push   $0x1
  70:	e8 eb 04 00 00       	call   560 <printf>
    matrix_multiply(A, B, C);
  75:	83 c4 0c             	add    $0xc,%esp
  78:	53                   	push   %ebx
  79:	57                   	push   %edi
  7a:	56                   	push   %esi
  7b:	e8 30 00 00 00       	call   b0 <matrix_multiply>
    printf(1, "2\n");
  80:	58                   	pop    %eax
  81:	5a                   	pop    %edx
  82:	68 8f 08 00 00       	push   $0x88f
  87:	6a 01                	push   $0x1
  89:	e8 d2 04 00 00       	call   560 <printf>

    // Print the result
    print_matrix(C);
  8e:	89 1c 24             	mov    %ebx,(%esp)
  91:	e8 aa 00 00 00       	call   140 <print_matrix>
    printf(1, "3\n");
  96:	59                   	pop    %ecx
  97:	5b                   	pop    %ebx
  98:	68 92 08 00 00       	push   $0x892
  9d:	6a 01                	push   $0x1
  9f:	e8 bc 04 00 00       	call   560 <printf>

    exit();
  a4:	e8 4a 03 00 00       	call   3f3 <exit>
  a9:	66 90                	xchg   %ax,%ax
  ab:	66 90                	xchg   %ax,%ax
  ad:	66 90                	xchg   %ax,%ax
  af:	90                   	nop

000000b0 <matrix_multiply>:
void matrix_multiply(int A[N][N], int B[N][N], int C[N][N]) {
  ...
  bf:	8b 75 10             	mov    0x10(%ebp),%esi
  c2:	89 7d f0             	mov    %edi,-0x10(%ebp)
  c5:	81 c7 00 04 00 00    	add    $0x400,%edi
  cb:	89 7d e4             	mov    %edi,-0x1c(%ebp)
  ce:	8d b8 00 04 00 00    	lea    0x400(%eax),%edi
  d4:	05 40 04 00 00       	add    $0x440,%eax
  d9:	89 75 e8             	mov    %esi,-0x18(%ebp)
  dc:	89 7d e0             	mov    %edi,-0x20(%ebp)
  df:	89 45 ec             	mov    %eax,-0x14(%ebp)
        for (j = 0; j < N; j++) {
  e2:	8b 7d e0             	mov    -0x20(%ebp),%edi
void matrix_multiply(int A[N][N], int B[N][N], int C[N][N]) {
  e5:	8b 75 e8             	mov    -0x18(%ebp),%esi
  e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ef:	90                   	nop
            C[i][j] = 0;
  f0:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  f6:	8b 5d f0             	mov    -0x10(%ebp),%ebx
  f9:	8d 87 00 fc ff ff    	lea    -0x400(%edi),%eax
  ff:	31 c9                	xor    %ecx,%ecx
 101:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                C[i][j] += A[i][k] * B[k][j];
 108:	8b 13                	mov    (%ebx),%edx
 10a:	0f af 10             	imul   (%eax),%edx
            for (k = 0; k < N; k++) {
 10d:	83 c0 40             	add    $0x40,%eax
 110:	83 c3 04             	add    $0x4,%ebx
                C[i][j] += A[i][k] * B[k][j];
 113:	01 d1                	add    %edx,%ecx
 115:	89 0e                	mov    %ecx,(%esi)
            for (k = 0; k < N; k++) {
 117:	39 f8                	cmp    %edi,%eax
 119:	75 ed                	jne    108 <matrix_multiply+0x58>
        for (j = 0; j < N; j++) {
 11b:	83 c6 04             	add    $0x4,%esi
 11e:	8d 78 04             	lea    0x4(%eax),%edi
 121:	3b 7d ec             	cmp    -0x14(%ebp),%edi
 124:	75 ca                	jne    f0 <matrix_multiply+0x40>
    for (i = 0; i < N; i++) {
 126:	83 45 f0 40          	addl   $0x40,-0x10(%ebp)
 12a:	8b 45 f0             	mov    -0x10(%ebp),%eax
 12d:	83 45 e8 40          	addl   $0x40,-0x18(%ebp)
 131:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
 134:	75 ac                	jne    e2 <matrix_multiply+0x32>
}
 136:	83 c4 14             	add    $0x14,%esp
 139:	5b                   	pop    %ebx
 13a:	5e                   	pop    %esi
 13b:	5f                   	pop    %edi
 13c:	5d                   	pop    %ebp
...
void print_matrix(int matrix[N][N]) {
 ...
 14c:	8d 77 40             	lea    0x40(%edi),%esi
 14f:	81 c7 40 04 00 00    	add    $0x440,%edi
 155:	8d 76 00             	lea    0x0(%esi),%esi
        for (j = 0; j < N; j++) {
 158:	8d 5e c0             	lea    -0x40(%esi),%ebx
 ...
 165:	83 c3 04             	add    $0x4,%ebx
            printf(1, "%d ", matrix[i][j]);
 168:	68 88 08 00 00       	push   $0x888
 16d:	6a 01                	push   $0x1
 16f:	e8 ec 03 00 00       	call   560 <printf>
        for (j = 0; j < N; j++) {
 174:	83 c4 10             	add    $0x10,%esp
 177:	39 f3                	cmp    %esi,%ebx
 179:	75 e5                	jne    160 <print_matrix+0x20>
        printf(1, "\n");
 17b:	83 ec 08             	sub    $0x8,%esp
    for (i = 0; i < N; i++) {
 17e:	8d 73 40             	lea    0x40(%ebx),%esi
        printf(1, "\n");
 181:	68 8d 08 00 00       	push   $0x88d
 186:	6a 01                	push   $0x1
 188:	e8 d3 03 00 00       	call   560 <printf>
    for (i = 0; i < N; i++) {
 18d:	83 c4 10             	add    $0x10,%esp
 190:	39 fe                	cmp    %edi,%esi
 192:	75 c4                	jne    158 <print_matrix+0x18>
}
...
sys_ps:
    movl SYS_ps, %eax
 49b:	a1 16 00 00 00       	mov    0x16,%eax
    int $64
 4a0:	cd 40                	int    $0x40
    ret
 4a2:	c3                   	ret    
 ...
 569:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d9:	ff 24 85 9c 08 00 00 	jmp    *0x89c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6e7:	90                   	nop
          s = "(null)";
 6e8:	ba 95 08 00 00       	mov    $0x895,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 701:	a1 04 0c 00 00       	mov    0xc04,%eax
{
 ...
 741:	5b                   	pop    %ebx
  freep = p;
 742:	89 15 04 0c 00 00    	mov    %edx,0xc04
}
 748:	5e                   	pop    %esi
 749:	5f                   	pop    %edi
 74a:	5d                   	pop    %ebp
 ...
 779:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 77c:	89 15 04 0c 00 00    	mov    %edx,0xc04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 799:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 79c:	8b 3d 04 0c 00 00    	mov    0xc04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7df:	73 4f                	jae    830 <malloc+0xa0>
    ...
    if(p == freep)
 7e1:	8b 3d 04 0c 00 00    	mov    0xc04,%edi
 ...
 80a:	e8 f1 fe ff ff       	call   700 <free>
  return freep;
 80f:	8b 15 04 0c 00 00    	mov    0xc04,%edx
 ...
 83c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 83f:	89 15 04 0c 00 00    	mov    %edx,0xc04
}
 ...
 84f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 850:	c7 05 04 0c 00 00 08 	movl   $0xc08,0xc04
 857:	0c 00 00 
    base.s.size = 0;
 85a:	bf 08 0c 00 00       	mov    $0xc08,%edi
    base.s.ptr = freep = prevp = &base;
 85f:	c7 05 08 0c 00 00 08 	movl   $0xc08,0xc08
 866:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 869:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 86b:	c7 05 0c 0c 00 00 00 	movl   $0x0,0xc0c
 872:	00 00 00 
    if(p->s.size >= nunits){
