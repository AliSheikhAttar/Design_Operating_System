...
int main(int argc, char *argv[]) {
  ...
  2b:	56                   	push   %esi
  2c:	53                   	push   %ebx
  2d:	e8 31 03 00 00       	call   363 <ps>
  exit();
  32:	e8 8c 02 00 00       	call   2c3 <exit>
    state = atoi(argv[1]);
  37:	83 ec 0c             	sub    $0xc,%esp
  3a:	ff 72 04             	push   0x4(%edx)
  ...
  if (argc > 2) {
  4a:	83 ff 02             	cmp    $0x2,%edi
  4d:	74 d9                	je     28 <main+0x28>
    pid = atoi(argv[2]);
  4f:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  52:	83 ec 0c             	sub    $0xc,%esp
  55:	ff 72 08             	push   0x8(%edx)
  58:	e8 f3 01 00 00       	call   250 <atoi>
