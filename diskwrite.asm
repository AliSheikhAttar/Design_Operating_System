...
_diskwrite:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  16:	8b 79 04             	mov    0x4(%ecx),%edi
    ...
    start_time = uptime();
  19:	e8 dd 03 00 00       	call   3fb <uptime>

    if (argc < 3) {
  1e:	83 fb 02             	cmp    $0x2,%ebx
  21:	7f 13                	jg     36 <main+0x36>
        // Print usage message to stderr (fd 2)
        printf(2, "Usage: diskwrite <filename> <text>\n");
  23:	52                   	push   %edx
  24:	52                   	push   %edx
  25:	68 60 08 00 00       	push   $0x860
  2a:	6a 02                	push   $0x2
  2c:	e8 9f 04 00 00       	call   4d0 <printf>
        exit();
  31:	e8 2d 03 00 00       	call   363 <exit>
  ...
  38:	50                   	push   %eax
  39:	50                   	push   %eax
  3a:	ff 77 08             	push   0x8(%edi)
  3d:	ff 77 04             	push   0x4(%edi)
  40:	e8 2b 00 00 00       	call   70 <write_to_file>
    end_time = uptime();
  45:	e8 b1 03 00 00       	call   3fb <uptime>
    printf(1, "Time taken: %d ticks\n", end_time - start_time);
  4a:	83 c4 0c             	add    $0xc,%esp
  4d:	29 f0                	sub    %esi,%eax
  4f:	50                   	push   %eax
  50:	68 23 08 00 00       	push   $0x823
  55:	6a 01                	push   $0x1
  57:	e8 74 04 00 00       	call   4d0 <printf>
    exit();
  5c:	e8 02 03 00 00       	call   363 <exit>
  61:	66 90                	xchg   %ax,%ax
  63:	66 90                	xchg   %ax,%ax
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
...
void write_to_file(char *filename, char *text) {
  ...
  7c:	8b 7d 0c             	mov    0xc(%ebp),%edi
    fd = open(filename, O_WRONLY | O_CREATE);
  7f:	68 01 02 00 00       	push   $0x201
  84:	56                   	push   %esi
  85:	e8 19 03 00 00       	call   3a3 <open>
    if (fd < 0) {
  8a:	83 c4 10             	add    $0x10,%esp
  8d:	85 c0                	test   %eax,%eax
  8f:	78 45                	js     d6 <write_to_file+0x66>
    n = strlen(text);
  91:	83 ec 0c             	sub    $0xc,%esp
  94:	89 c3                	mov    %eax,%ebx
  96:	57                   	push   %edi
  97:	e8 04 01 00 00       	call   1a0 <strlen>
    if (write(fd, text, n) != n) {
  9c:	83 c4 0c             	add    $0xc,%esp
  9f:	50                   	push   %eax
  a0:	57                   	push   %edi
  a1:	53                   	push   %ebx
  a2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  a5:	e8 d9 02 00 00       	call   383 <write>
  aa:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  ad:	83 c4 10             	add    $0x10,%esp
  b0:	39 d0                	cmp    %edx,%eax
  b2:	75 35                	jne    e9 <write_to_file+0x79>
    printf(1, "Successfully wrote to the file %s\n", filename); // Debugging print
  b4:	83 ec 04             	sub    $0x4,%esp
  b7:	56                   	push   %esi
  b8:	68 3c 08 00 00       	push   $0x83c
  bd:	6a 01                	push   $0x1
  bf:	e8 0c 04 00 00       	call   4d0 <printf>
    close(fd);
  ...
  d0:	5d                   	pop    %ebp
    close(fd);
  d1:	e9 b5 02 00 00       	jmp    38b <close>
        printf(2, "Error: cannot open %s\n", filename);
  d6:	52                   	push   %edx
  d7:	56                   	push   %esi
  d8:	68 f8 07 00 00       	push   $0x7f8
  dd:	6a 02                	push   $0x2
  df:	e8 ec 03 00 00       	call   4d0 <printf>
        exit();
  e4:	e8 7a 02 00 00       	call   363 <exit>
        printf(2, "Error: write error\n");
  e9:	50                   	push   %eax
  ea:	50                   	push   %eax
  eb:	68 0f 08 00 00       	push   $0x80f
  f0:	6a 02                	push   $0x2
  f2:	e8 d9 03 00 00       	call   4d0 <printf>
        close(fd);
  f7:	89 1c 24             	mov    %ebx,(%esp)
  fa:	e8 8c 02 00 00       	call   38b <close>
        exit();
...
sys_ps:
    movl SYS_ps, %eax
 40b:	a1 16 00 00 00       	mov    0x16,%eax
    int $64
 410:	cd 40                	int    $0x40
    ret
 412:	c3                   	ret    
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 e4 08 00 00 	movzbl 0x8e4(%edx),%edx
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 8c 08 00 00 	jmp    *0x88c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 84 08 00 00       	mov    $0x884,%edx
        while(*s != 0){
