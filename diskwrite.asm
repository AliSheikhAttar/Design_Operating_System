...
int main(int argc, char *argv[]) {
  ...
  20:	6a 02                	push   $0x2
  22:	e8 79 04 00 00       	call   4a0 <printf>
        exit();
  ...
  34:	e8 07 00 00 00       	call   40 <write_to_file>
    exit();
  39:	e8 f5 02 00 00       	call   333 <exit>
  3e:	66 90                	xchg   %ax,%ax

00000040 <write_to_file>:
void write_to_file(char *filename, char *text) {
  ...
  44:	56                   	push   %esi
  45:	53                   	push   %ebx
  46:	83 ec 24             	sub    $0x24,%esp
  49:	8b 75 08             	mov    0x8(%ebp),%esi
  4c:	8b 7d 0c             	mov    0xc(%ebp),%edi
    fd = open(filename, O_WRONLY | O_CREATE);
  4f:	68 01 02 00 00       	push   $0x201
  54:	56                   	push   %esi
  55:	e8 19 03 00 00       	call   373 <open>
    if (fd < 0) {
  5a:	83 c4 10             	add    $0x10,%esp
  5d:	85 c0                	test   %eax,%eax
  5f:	78 45                	js     a6 <write_to_file+0x66>
    n = strlen(text);
  61:	83 ec 0c             	sub    $0xc,%esp
  64:	89 c3                	mov    %eax,%ebx
  66:	57                   	push   %edi
  67:	e8 04 01 00 00       	call   170 <strlen>
  ...
  75:	e8 d9 02 00 00       	call   353 <write>
  7a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  7d:	83 c4 10             	add    $0x10,%esp
  80:	39 d0                	cmp    %edx,%eax
  82:	75 35                	jne    b9 <write_to_file+0x79>
  ...
  9a:	8d 65 f4             	lea    -0xc(%ebp),%esp
  9d:	5b                   	pop    %ebx
  9e:	5e                   	pop    %esi
  9f:	5f                   	pop    %edi
  a0:	5d                   	pop    %ebp
    close(fd);
  a1:	e9 b5 02 00 00       	jmp    35b <close>
        printf(2, "Error: cannot open %s\n", filename);
  a6:	52                   	push   %edx
  a7:	56                   	push   %esi
  a8:	68 c8 07 00 00       	push   $0x7c8
  ad:	6a 02                	push   $0x2
  ...
  b9:	50                   	push   %eax
  ba:	50                   	push   %eax
  bb:	68 df 07 00 00       	push   $0x7df
  c0:	6a 02                	push   $0x2
  c2:	e8 d9 03 00 00       	call   4a0 <printf>
        close(fd);
  c7:	89 1c 24             	mov    %ebx,(%esp)
  ca:	e8 8c 02 00 00       	call   35b <close>
        exit();
  cf:	e8 5f 02 00 00       	call   333 <exit>
  d4:	66 90                	xchg   %ax,%ax
  d6:	66 90                	xchg   %ax,%ax
  d8:	66 90                	xchg   %ax,%ax
  da:	66 90                	xchg   %ax,%ax
...
sys_ps:
    movl SYS_ps, %eax
 3db:	a1 16 00 00 00       	mov    0x16,%eax
    int $64
 3e0:	cd 40                	int    $0x40
    ret
 3e2:	c3                   	ret    
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 3c 08 00 00       	mov    $0x83c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 74 0b 00 00       	mov    0xb74,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 74 0b 00 00    	mov    %edx,0xb74
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 74 0b 00 00    	mov    %edx,0xb74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 74 0b 00 00    	mov    0xb74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 74 0b 00 00    	mov    0xb74,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 74 0b 00 00    	mov    0xb74,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 74 0b 00 00    	mov    %edx,0xb74
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 74 0b 00 00 78 	movl   $0xb78,0xb74
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 78 0b 00 00       	mov    $0xb78,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 78 0b 00 00 78 	movl   $0xb78,0xb78
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 7c 0b 00 00 00 	movl   $0x0,0xb7c
 7b2:	00 00 00 
    if(p->s.size >= nunits){
