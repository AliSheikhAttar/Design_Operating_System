...
int main(int argc, char *argv[]) {
  14:	53                   	push   %ebx
  int state_t = -1; // -1 means do not filter by state
  15:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
int main(int argc, char *argv[]) {
  1a:	51                   	push   %ecx
  ...
  if (argc > 1) {
  23:	83 ff 01             	cmp    $0x1,%edi
  26:	7f 1a                	jg     42 <main+0x42>
  }
...
struct proc_info *process_info_t;
  ...
  if (argc > 2) {
  55:	83 ff 02             	cmp    $0x2,%edi
  58:	74 ce                	je     28 <main+0x28>
    pid_t = atoi(argv[2]);
  5a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  5d:	83 ec 0c             	sub    $0xc,%esp
  60:	ff 72 08             	push   0x8(%edx)
  63:	e8 e8 01 00 00       	call   250 <atoi>
  68:	83 c4 10             	add    $0x10,%esp
  6b:	89 c6                	mov    %eax,%esi
  6d:	eb b9                	jmp    28 <main+0x28>
  6f:	90                   	nop
...
sys_ps:
    movl SYS_ps, %eax
 36b:	a1 16 00 00 00       	mov    0x16,%eax
    int $64
 370:	cd 40                	int    $0x40
    ret
 372:	c3                   	ret    
 ...
 5d1:	a1 70 0a 00 00       	mov    0xa70,%eax
{
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 70 0a 00 00    	mov    %edx,0xa70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 70 0a 00 00    	mov    0xa70,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 70 0a 00 00    	mov    %edx,0xa70
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 70 0a 00 00 74 	movl   $0xa74,0xa70
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf 74 0a 00 00       	mov    $0xa74,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 742:	00 00 00 
    if(p->s.size >= nunits){
