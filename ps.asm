...
int main(int argc, char *argv[]) {
  ...
  char* name_t = (char*) malloc(16);
  23:	e8 58 06 00 00       	call   680 <malloc>
  int state_t = -1; // -1 means do not filter by state
  28:	c7 45 e4 ff ff ff ff 	movl   $0xffffffff,-0x1c(%ebp)
  if (argc > 1) {
  2f:	83 c4 10             	add    $0x10,%esp
  char* name_t = (char*) malloc(16);
  32:	89 c3                	mov    %eax,%ebx
  if (argc > 1) {
  34:	83 ff 01             	cmp    $0x1,%edi
  37:	7f 1d                	jg     56 <main+0x56>
  }
...
struct proc_info *process_info_t;
  ...
  3c:	6a 1c                	push   $0x1c
  3e:	e8 3d 06 00 00       	call   680 <malloc>
  ps(state_t, pid_t, process_info_t, name_t);
  43:	53                   	push   %ebx
  44:	50                   	push   %eax
  45:	56                   	push   %esi
  46:	ff 75 e4             	push   -0x1c(%ebp)
  49:	e8 35 03 00 00       	call   383 <ps>
  //printf("pid: %d state: %d name: %s\n", (int)process_info_t->pid, (int)process_info_t->state, (char*)process_info_t->name);
  exit();
  4e:	83 c4 20             	add    $0x20,%esp
  51:	e8 8d 02 00 00       	call   2e3 <exit>
    state_t = atoi(argv[1]);
  56:	8b 45 e0             	mov    -0x20(%ebp),%eax
  59:	83 ec 0c             	sub    $0xc,%esp
  5c:	ff 70 04             	push   0x4(%eax)
  5f:	e8 0c 02 00 00       	call   270 <atoi>
  if (argc > 2) {
  64:	83 c4 10             	add    $0x10,%esp
    state_t = atoi(argv[1]);
  67:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if (argc > 2) {
  6a:	83 ff 02             	cmp    $0x2,%edi
  6d:	74 ca                	je     39 <main+0x39>
    pid_t = atoi(argv[2]);
  6f:	8b 45 e0             	mov    -0x20(%ebp),%eax
  72:	83 ec 0c             	sub    $0xc,%esp
  75:	ff 70 08             	push   0x8(%eax)
  78:	e8 f3 01 00 00       	call   270 <atoi>
  if (argc > 3) {
  7d:	83 c4 10             	add    $0x10,%esp
    pid_t = atoi(argv[2]);
  80:	89 c6                	mov    %eax,%esi
  if (argc > 3) {
  82:	83 ff 03             	cmp    $0x3,%edi
  85:	74 b2                	je     39 <main+0x39>
    name_t = argv[3];
  87:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8a:	8b 58 0c             	mov    0xc(%eax),%ebx
  8d:	eb aa                	jmp    39 <main+0x39>
  8f:	90                   	nop
...
sys_ps:
    movl SYS_ps, %eax
 38b:	a1 16 00 00 00       	mov    0x16,%eax
    int $64
 390:	cd 40                	int    $0x40
    ret
 392:	c3                   	ret    
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 80 07 00 00 	jmp    *0x780(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 78 07 00 00       	mov    $0x778,%edx
        while(*s != 0){
 ...
 5f1:	a1 90 0a 00 00       	mov    0xa90,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 90 0a 00 00    	mov    %edx,0xa90
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 90 0a 00 00    	mov    %edx,0xa90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d 90 0a 00 00    	mov    0xa90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d 90 0a 00 00    	mov    0xa90,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 90 0a 00 00    	mov    0xa90,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 90 0a 00 00    	mov    %edx,0xa90
}
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 90 0a 00 00 94 	movl   $0xa94,0xa90
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf 94 0a 00 00       	mov    $0xa94,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 94 0a 00 00 94 	movl   $0xa94,0xa94
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 98 0a 00 00 00 	movl   $0x0,0xa98
 762:	00 00 00 
    if(p->s.size >= nunits){
