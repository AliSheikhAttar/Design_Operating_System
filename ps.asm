...
int main(int argc, char *argv[]) {
  ...
  1c:	0f 8e b2 00 00 00    	jle    d4 <main+0xd4>
        if (argv[1][0] != '-')
  22:	8b 47 04             	mov    0x4(%edi),%eax
    int state_t = -1; // -1 means do not filter by state
  25:	83 ca ff             	or     $0xffffffff,%edx
        if (argv[1][0] != '-')
  28:	80 38 2d             	cmpb   $0x2d,(%eax)
  2b:	75 7b                	jne    a8 <main+0xa8>
            state_t = atoi(argv[1]);
    
    if (argc > 2)
  2d:	83 fb 02             	cmp    $0x2,%ebx
  30:	0f 84 ae 00 00 00    	je     e4 <main+0xe4>
        if (argv[2][0] != '-')
  36:	8b 47 08             	mov    0x8(%edi),%eax
    int pid_t = -1;   // -1 means do not filter by PID
  39:	83 ce ff             	or     $0xffffffff,%esi
        if (argv[2][0] != '-')
  3c:	80 38 2d             	cmpb   $0x2d,(%eax)
  3f:	75 7a                	jne    bb <main+0xbb>
            pid_t = atoi(argv[2]);
    
    if (argc > 3)
  41:	83 fb 03             	cmp    $0x3,%ebx
  44:	0f 84 a7 00 00 00    	je     f1 <main+0xf1>
        name_t = argv[3];
  4a:	8b 7f 0c             	mov    0xc(%edi),%edi
    
    printf(1, "state-userspace: %d\n", state_t);
  4d:	83 ec 04             	sub    $0x4,%esp
  50:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  53:	52                   	push   %edx
  54:	68 ed 07 00 00       	push   $0x7ed
  59:	6a 01                	push   $0x1
  5b:	e8 60 04 00 00       	call   4c0 <printf>
    printf(1, "id-userspace: %d\n", pid_t);
  60:	83 c4 0c             	add    $0xc,%esp
  63:	56                   	push   %esi
  64:	68 02 08 00 00       	push   $0x802
  69:	6a 01                	push   $0x1
  6b:	e8 50 04 00 00       	call   4c0 <printf>
    printf(1, "name-userspace: %s\n", name_t);
  70:	83 c4 0c             	add    $0xc,%esp
  73:	57                   	push   %edi
  74:	68 14 08 00 00       	push   $0x814
  79:	6a 01                	push   $0x1
  7b:	e8 40 04 00 00       	call   4c0 <printf>

    struct proc_info *process_info_t;
    process_info_t = (struct proc_info*) malloc(sizeof(struct proc_info));
  80:	c7 04 24 1c 00 00 00 	movl   $0x1c,(%esp)
  87:	e8 64 06 00 00       	call   6f0 <malloc>
  ...
  93:	56                   	push   %esi
  94:	52                   	push   %edx
  95:	e8 59 03 00 00       	call   3f3 <ps>

    free(process_info_t);  // free before exit
  9a:	83 c4 14             	add    $0x14,%esp
  9d:	53                   	push   %ebx
  9e:	e8 bd 05 00 00       	call   660 <free>
    exit();  // use exit properly
  a3:	e8 ab 02 00 00       	call   353 <exit>
            state_t = atoi(argv[1]);
  a8:	83 ec 0c             	sub    $0xc,%esp
  ab:	50                   	push   %eax
  ac:	e8 2f 02 00 00       	call   2e0 <atoi>
  b1:	83 c4 10             	add    $0x10,%esp
  b4:	89 c2                	mov    %eax,%edx
  b6:	e9 72 ff ff ff       	jmp    2d <main+0x2d>
            pid_t = atoi(argv[2]);
  bb:	83 ec 0c             	sub    $0xc,%esp
  be:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  c1:	50                   	push   %eax
  c2:	e8 19 02 00 00       	call   2e0 <atoi>
  c7:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  ca:	83 c4 10             	add    $0x10,%esp
  cd:	89 c6                	mov    %eax,%esi
  cf:	e9 6d ff ff ff       	jmp    41 <main+0x41>
    int pid_t = -1;   // -1 means do not filter by PID
  d4:	83 ce ff             	or     $0xffffffff,%esi
    int state_t = -1; // -1 means do not filter by state
  d7:	83 ca ff             	or     $0xffffffff,%edx
    char* name_t = "None";
  da:	bf e8 07 00 00       	mov    $0x7e8,%edi
  df:	e9 69 ff ff ff       	jmp    4d <main+0x4d>
    int pid_t = -1;   // -1 means do not filter by PID
  e4:	83 ce ff             	or     $0xffffffff,%esi
    char* name_t = "None";
  e7:	bf e8 07 00 00       	mov    $0x7e8,%edi
  ec:	e9 5c ff ff ff       	jmp    4d <main+0x4d>
  f1:	bf e8 07 00 00       	mov    $0x7e8,%edi
  f6:	e9 52 ff ff ff       	jmp    4d <main+0x4d>
  fb:	66 90                	xchg   %ax,%ax
  fd:	66 90                	xchg   %ax,%ax
  ff:	90                   	nop
...
sys_ps:
    movl SYS_ps, %eax
 3fb:	a1 16 00 00 00       	mov    0x16,%eax
    int $64
 400:	cd 40                	int    $0x40
    ret
 402:	c3                   	ret    
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 88 08 00 00 	movzbl 0x888(%edx),%edx
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 30 08 00 00 	jmp    *0x830(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 28 08 00 00       	mov    $0x828,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 3c 0b 00 00       	mov    0xb3c,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 3c 0b 00 00    	mov    %edx,0xb3c
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 3c 0b 00 00    	mov    %edx,0xb3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 3c 0b 00 00    	mov    0xb3c,%edx
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 3c 0b 00 00 40 	movl   $0xb40,0xb3c
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 40 0b 00 00       	mov    $0xb40,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 40 0b 00 00 40 	movl   $0xb40,0xb40
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 44 0b 00 00 00 	movl   $0x0,0xb44
 7d2:	00 00 00 
    if(p->s.size >= nunits){
